...
import JCustomizedSelect from './JCustomizedSelect';
import { FormHelperText } from '@material-ui/core';
import { Grid } from '@material-ui/core';
import ValidatorComponent from '../../FormValidator/ValidatorComponent';
import { ErrorOutline } from '@material-ui/icons';

class JCustomizedSelectFieldValidator extends ValidatorComponent {
    // static defaultState = {
    //     isValid: true,
    //     errorMessages: [],
    //     validators: [],
    ...
    errorMessage() {
        ...
        return (
            <FormHelperText error style={{ marginTop: 0,fontSize: '1rem',fontFamily: 'Arial',padding: 0}} id={id}>
                ...
                {/* <ErrorOutline style={{ fontSize:14,height:'1rem',width:'1rem'}}/> */}
...
JCustomizedSelectFieldValidator.defaultProps = {
    errorMessages: '',
    validators: [],
    validatorListener: () => { },
    isRequired: false,
...
export default JCustomizedSelectFieldValidator;
