...
class JSelectFieldValidator extends ValidatorComponent {
    ...
    errorMessage() {
        ...
        const width = this.containerRef && this.containerRef.clientWidth;
        if (isValid) {
            return null;
        }
...
JSelectFieldValidator.propTypes = {
...
JSelectFieldValidator.defaultProps = {
...
export default JSelectFieldValidator;