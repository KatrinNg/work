...
const FormControlCreatableSelect = ({ isDisabled, value, name, onChange, options, label }) => {
    const classes = useStyles();

    const [focus, setfocus] = useState(false);

    const focusBlurHandler = () => setfocus(!focus);
    ...
    return (
        ...
        >
            <InputLabel
                className={
                    focus
                        ? classes.activeSelectLabel
                        : isDisabled || !value
                        ? classes.inactiveSelectLabel
                        : classes.activeSelectLabel
                }
...
FormControlCreatableSelect.propTypes = {
...
export default FormControlCreatableSelect;
