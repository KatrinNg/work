...
class CIMSDialog extends Component {
    render() {
        const {
            classes,
            formControlStyle,
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <DialogTitle id={id + '_dialogTitle'} onClose={onCloseIcon}>{dialogTitle}</DialogTitle>
                    <FormControl
                        {...dialogContentProps}
...
export default withStyles(styles)(CIMSDialog);