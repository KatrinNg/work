    ...
    return (
      <MuiThemeProvider theme={customTheme}>
        <FormControl className={classes.formControl}>
          <Select id="mutiple-checkbox" multiple value={personName} onChange={this.handleChange} renderValue={(selected) => selected.join(', ')} variant="outlined">
            {names.map((name) => (
