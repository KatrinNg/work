...
class RegDateBirthField extends React.Component {
    constructor(props) {
        super(props);
    ...
    extDobOnChange = (value) => {
        ...
        if (this.props.dobValue instanceof moment) {
            if (!this.props.dobValue.isValid()) {
                ...
                dobData.dob = this.props.dobValue;
            }
        } else {
            // this.handleOnChange(null, 'dob');
            if (moment(this.props.dobValue).isValid()) {
                dobData.dob = this.props.dobValue;
            } else {
                dobData.dob = null;
            }
        }
        this.props.handleExtDobChange(dobData);
        this.foucusDob();
        this.dateOfBirthRef.validateCurrent();
    }
                ...
                <Grid container item wrap="nowrap">
                    <Grid item xs={6}>
                        <DateFieldValidator
                            ...
                            inputRef={ref => this.dobInputRef = ref}
                            key={date_format}
                            id={id + '_dateOfBirth'}
                            name={id + '_dateOfBirth'}
                    ...
                    <Grid item xs={6}>
                        <SelectFieldValidator
                            ...
                            onChange={e => this.extDobOnChange(e.value)}
...
export default withStyles(styles)(RegDateBirthField);