...
import * as documentUtilities from '../../../utilities/documentUtilities';
...
class DocumentViewer extends React.Component {
    ...
    print = () => {
        if (this.props.previewData) {
            ...
            if (documentUtilities.getHospSetting().enableCcp) {
                this.props.print(this.props.previewData, callback);
            } else {
                try {
                    const blob = documentUtilities.b64toBlob(this.props.previewData.reportBase64, 'application/pdf');
    ...
    render() {
        ...
        let documentData64 = previewData;
                        ...
                        <div style={{ height: `calc(${window.screen.height - 310}px)`, width: '100%' }} >
                            <Grid container style={{ dispaly: 'flex', justifyContent: this.state.justifyContent, backgroundColor: '#535353', padding: this.state.padding }}>
                                <Document
                                    ...
                                    file={documentData64 ? documentUtilities.b64toBlob(documentData64, 'application/pdf') : null}
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(DocumentViewer));