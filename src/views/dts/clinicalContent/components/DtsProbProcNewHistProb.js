...
class DtsProbProcNewHistProb extends React.Component {
  constructor (props) {
    super(props);
  ...
  render () {
      ...
      return (
        <MaterialTable 
            ...
            data={this.produceGroupforProblem(problemQualifier.filter(i => i.diagnosisStatusCd == 'A' && i.dtsIsHistory == 1 && i.isCurProb != 'Y'))}
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(DtsProbProcNewHistProb));
