...
class DtsReserveListGrid extends Component {
    constructor(props) {
        super(props);
        ...
        let columnDefs = [
            ...
            {
                headerName: 'Priority',
                valueGetter: (params) => params.data.reserve.priority,
                cellClass: classes.basicCell,
                headerClass: classes.basicHeader,
                width: 90
            },
            {
                headerName: 'Remarks',
                valueGetter: (params) => params.data.reserve.remarks,
                cellClass: classes.basicCell,
                headerClass: classes.basicHeader,
                width: 90
            },
            ...
            //     valueGetter: (params) => params.data.reserve.reservedDate,
            //     cellClass: classes.basicCell,
            //     headerClass: classes.basicHeader,
            //     width: 90
            // },
            ...
            },
            {
                ...
                valueGetter: (params) => this.getDuration(params.data.appointmentDetlBaseVoList[0].mapAppointmentTimeSlotVosList),
                cellClass: [classes.basicCell],
                filter:false,
                headerClass: classes.basicHeader,
                width: 90
    ...
    componentDidMount(){
        this.setState({ rowData: this.props.reserveList});
    }

    componentDidUpdate(prevProps) {
        if (prevProps.reserveList !== this.props.reserveList) {
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(DtsReserveListGrid));
