...
class SpecialInterval extends Component {
  ...
  specailIntervalValidatorListener(isValid, msg, id, regimen, textBoxId, isError) {
    ...
    if (!isValid) {
      ...
      // }
      // if(regimen === 'C'||'M'){
      //   if(textBoxId==='fromDay'){
      //     // this.refs.CycleToDay.validateCurrent();
      //     this.refs.MonthlyToDay.validateCurrent();
      //   }else if(textBoxId==='toDay'){
      //     // this.refs.CycleFromDay.validateCurrent();
      //     this.refs.MonthlyFromDay.validateCurrent();
      //   }
      // }
      // if (regimen === 'C') {
      //   if (this.state.ValidCycleFromToDay)
      //     validObj.style.color = 'red';
      // } else if (regimen === 'M') {
      //   if (this.state.ValidMonthlyFromToDay)
      //     validObj.style.color = 'red';
      // } else {
      if (!isError) {
  ...
  render() {
    const { classes, index, codeList } = this.props;
      ...
      <Typography component="div">
        ...
        <Typography component="div" className={classes.root}>
          <Typography component="div" className={classes.tabs}>
            <Button
                id={'prescription_PrescriptionPanel' + index + '_specialIntervalBtnDaily'}
            ...
            <Button
                id={'prescription_PrescriptionPanel' + index + '_specialIntervalBtnWeekly'}
            ...
            <Button
                id={'prescription_PrescriptionPanel' + index + '_specialIntervalBtnMonthly'}
            ...
            <Button
                id={'prescription_PrescriptionPanel' + index + '_specialIntervalBtnCyclic'}
            ...
            <Typography component="div" {...contentProps('C', specialIntervalData.regimen)}>
              ...
              <Grid container direction="column" justify="space-between" alignItems="stretch" className={classes.inputArea}>
                <Grid container style={{ marginLeft: '-10px' }} id="eachCycle">
                  ...
                  <Grid item>
                    <TextFieldValidator
                        id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldEachCycle'}
                        ref="EachCycleRef"
                ...
                <Grid item container>
                  <Grid item>
                    <FormControlLabel
                        control={
                        <Radio
                            id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioOnDayOfTheCycle'}
                  ...
                  <Grid item id="onDayOfTheCycle" container xs={10}>
                    ...
                    <Grid item>
                      <TextFieldValidator
                          id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldOnDayOfTheCycle'}
                ...
                <Grid item container>
                  <Grid item>
                    <FormControlLabel
                        control={
                        <Radio
                            id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioDaysPerCycle'}
                  ...
                  <Grid item style={{ marginLeft: '-17px' }}>
                    <TextFieldValidator
                        id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldDaysPerCycle'}
                ...
                <Grid item container id="cycleFromToDay">
                  <Grid item>
                    <FormControlLabel
                        control={
                        <Radio
                            id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioCycleFromToDay'}
                  ...
                  <Grid item>
                    <TextFieldValidator
                        id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldCycleFromDay'}
                      // ref="CycleFromDay"
                  ...
                  <Grid item>
                    <TextFieldValidator
                        id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldCycleToDay'}
                      // ref="CycleToDay"
                ...
                <SpecialActions index={index} handleCancelSpecInter={this.props.handleCancelSpecInter}
...
function SpecialActions(props) {
  const { index, handleCancelSpecInter } = props;
  return <Grid container item justify={'flex-end'}>
    <CIMSButton
        id={'prescription_PrescriptionPanel' + index + '_specialIntervalBtnOK'}
        type="submit"
    ...
    <CIMSButton
        id={'prescription_PrescriptionPanel' + index + '_specialIntervalBtnCancel'}
        type="button"
...
function Daily(props) {
  const { index, specialIntervalData, classes, handleCancelSpecInter,
  ...
  return <Grid container direction="column" justify="space-between" alignItems="stretch" className={classes.inputArea}>
    <Grid item>
      <FormControlLabel
          control={
          <Radio
              id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioOnAlternateDays'}
    ...
    <Grid item>
      <FormControlLabel
          control={
          <Radio
              id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioOnOddEvenDays'}
    ...
    <Grid item container>
      <Grid item>
        <FormControlLabel
            control={
            <Radio
                id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioEveryDays'}
      ...
      <Grid container item xs={10} id="evrydays">
        ...
        <Grid item>
          <TextFieldValidator
              id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldEveryDays'}
    ...
    <SpecialActions
        index={index}
        handleCancelSpecInter={handleCancelSpecInter}
        disabledBtn={specialIntervalData && specialIntervalData.regimen && specialIntervalData.supplFreqId}
    />
  </Grid>;
}
...
function Weekly(props) {
  const { index, specialIntervalData, classes, weekDayCodeList, handleCancelSpecInter,
  ...
  return <Grid container direction="column" justify="space-between" alignItems="stretch" className={classes.inputArea}>
    <Grid item container>
      <Grid item>
        <FormControlLabel
            control={
            <Radio
                id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioDaysPerWeek'}
      ...
      <Grid container xs={10} item style={{ marginLeft: '-17px' }} id="daysPerWeek">
        <Grid item>
          <TextFieldValidator
              id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldDaysPerWeek'}
    ...
    <Grid item container>
      <Grid item>
        <FormControlLabel
            control={
            <Radio
                id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioEveryWeeks'}
      ...
      <Grid container item xs={10} id="everyWeeks">
        ...
        <Grid item>
          <TextFieldValidator
              id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldEveryWeeks'}
    ...
    <Grid container item>
      <Grid item>
        <FormControlLabel
            control={
            <Radio
                id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioWeekDay'}
                value="21"
                color="primary"
      ...
      <Grid item xs={11} style={{ marginLeft: '-17px' }}>
        {weekDayCodeList.map((item, i) => {
          ...
          return <FormControlLabel
              ...
              control={
              <CIMSCheckbox
                  id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioWeekDay_CHK' + item.engDesc}
                  checked={isCheck}
                  value={item.code}
    ...
    <SpecialActions index={index} handleCancelSpecInter={handleCancelSpecInter}
        disabledBtn={specialIntervalData && specialIntervalData.regimen && specialIntervalData.supplFreqId}
    />
  </Grid>;
}
    ...
    <Grid item container>
      <Grid item>
        <FormControlLabel
            control={
            <Radio
                id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioDaysPerMonth'}
      ...
      <Grid item style={{ marginLeft: '-17px' }}>
        <TextFieldValidator
            id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldDaysPerMonth'}
    ...
    <Grid item container id="monthlyFromToDay">
      <Grid item>
        <FormControlLabel
            control={
            <Radio
                id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioMonthlyFromToDay'}
      ...
      <Grid item>
        <TextFieldValidator
            id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldMonthlyFromDay'}
          // ref="MonthlyFromDay"
      ...
      <Grid item>
        <TextFieldValidator
            id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldMonthlyToDay'}
          // ref="MonthlyToDay"
    ...
    <Grid item container>
      <Grid item>
        <FormControlLabel
            control={
            <Radio
                id={'prescription_PrescriptionPanel' + index + '_specialIntervalRadioEveryMonth'}
      ...
      <Grid item container xs={10} id="everyMonths">
        ...
        <Grid item>
          <TextFieldValidator
              id={'prescription_PrescriptionPanel' + index + '_specialIntervalTextFieldEveryMonth'}
