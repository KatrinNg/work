...
const styleStore = getState(state => state.cimsStyle.color) || {};
...
const customColor = {
    ...
    cimsBackgroundColor: styleStore.cimsBackgroundColor,
    cimsTextColor: styleStore.cimsTextColor,
    cimsPlaceholderColor: styleStore.cimsPlaceholderColor,
    cimsLabelColor: styleStore.cimsLabelColor,
    cimsDisableColor: styleStore.cimsDisableColor
};
...
export default {
    ...
    text: {
        primary: customColor.cimsTextColor,
        secondary: '#6e6e6e',
        // disabled: 'rgba(0, 0, 0, 0.38)',
        // disabled: 'rgba(132, 132, 132)',
        disabled: customColor.cimsTextColor,
