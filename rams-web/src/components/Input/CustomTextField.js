...
const CustomTextField = ({
    ...
    const onValueChange = (e) => {
        ...
        if (numberField) {
            ...
            if (maxNum && value * 1 > maxNum) {
                value = maxNum;
                // return
            }
            if (minNum && value * 1 < minNum) {
                value = minNum;
                // return
            }
            if (isNaN(value)) {
    ...
    return (
        <div id={uid} style={{ ...extraStyle, ...style }} className={classes.SLayout}>
            <TextField
                InputProps={{
                    style: {
                        fontSize: 14,
                ...
                inputProps={numberField && { min:minNum,max:maxNum }}
                InputLabelProps={{
                    style: {
                        fontSize: 14,
                    },
                ...
                onPaste={(e) => {
                    ...
                    if (numberField && (value.includes('e') || !reg.test(value)) && parseInt(value) < 0) {
                        e.preventDefault();
                    }
                }}
                variant="outlined"
