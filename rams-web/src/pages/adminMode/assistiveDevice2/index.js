...
const AssistiveDevice1 = () => {
    ...
    const { assistiveDevice2List } = useSelector(state => state.adminmode)
    useEffect(()=>{
        dispatch({
    ...
    return (
        <MainContentUI id={'assistiveDevice2'} title="Assistive Device (2)" list={assistiveDevice2List} onSave={ handleSave}/>
    )
}
